...
<template>
  <div class="relative">
    <div class="hover sorter l-vw-20" @click="prevChange">
    ...
    <slot name="content" />
    <div class="hover sorter r-vw-20" @click="nextChange">
...
.sorter {
  --at-apply: fixed fsz-1 w-10 h-10 z-9 f-c-c bg-color t-vh-50 rd-l-4;
  opacity: 0.7;
}
